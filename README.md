...
2. Install a **downloader** (`yt-dlp` or `youtube-dl` &rarr; **Check for a recent version!** ) and `FFMPEG` with your prefered package manager. **Optional:** Also install `jq` and `kid3-cli` to imbed lyrics.
